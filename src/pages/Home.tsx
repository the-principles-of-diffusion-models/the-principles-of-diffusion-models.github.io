    ...
    <div className="min-h-screen transition-colors duration-200 bg-[#F8F2FF] dark:bg-slate-900">
      ...
      <div className="max-w-5xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
        <header className="text-center mb-12">
          <h1 className="text-5xl sm:text-6xl font-bold text-slate-900 dark:text-slate-100 mb-3 leading-tight">
            The Principles of Diffusion Models
          </h1>
          <p className="text-2xl sm:text-3xl text-slate-700 dark:text-slate-300 font-medium mb-6">
