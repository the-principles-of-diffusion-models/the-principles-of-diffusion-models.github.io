    ...
    <div className="not-prose mt-6 mb-8 overflow-hidden rounded-2xl border border-orange-200 bg-gradient-to-br from-orange-50 via-white to-amber-50 shadow-sm dark:border-orange-900/60 dark:from-orange-950/20 dark:via-slate-900 dark:to-amber-950/20">
      <div className="border-b border-orange-100 px-5 py-4 dark:border-orange-900/50 sm:px-6">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <a
            href={officialBlogpostUrl}
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex shrink-0 items-center justify-center gap-2 rounded-full bg-slate-900 px-4 py-2 text-sm font-semibold text-white shadow-sm transition hover:bg-slate-700 dark:bg-white dark:text-slate-900 dark:hover:bg-slate-200"
            aria-label="Open the official ICLR Blogpost in a new tab"
          >
            Read official post
      ...
      <div className="px-5 py-4 sm:px-6">
        ...
        <pre className="max-h-[28rem] overflow-x-auto rounded-xl border border-slate-200 bg-white/90 p-4 text-xs leading-relaxed text-slate-800 shadow-inner dark:border-slate-700 dark:bg-slate-950/80 dark:text-slate-200 whitespace-pre-wrap break-words">
          <code>{iclrBibTeX}</code>
        </pre>
      </div>
    </div>
  );
        ...
        <div className="grid grid-cols-1 gap-8 xl:grid-cols-[17rem_minmax(0,1fr)]">
          ...
          <div className="space-y-8">
            ...
            <section>
              ...
              <BlockMath math="\Psi_{s\to 0}(\mathbf{x}_s) \;\approx\; \mathbf{f}_{\theta^-}(\Psi_{s\to s-\Delta s}(\mathbf{x}_s),\,s-\Delta s), \qquad \Delta s>0." />
