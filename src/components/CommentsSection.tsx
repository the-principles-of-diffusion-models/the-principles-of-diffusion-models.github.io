...
export default function CommentsSection() {
  ...
  function getCommentIdFromUrl(): string | null {
    // HashRouter URL looks like: https://.../#/?comment=<id>
        ...
        <div className="space-y-4">
          ...
          <div>
            <label htmlFor="content" className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-2">
              Comment <span className="text-red-500">*</span> <span className="text-xs text-slate-500 dark:text-slate-400">(supports LaTeX: $inline$ or $$block$$)</span>
            </label>
            <textarea
              id="content"
              value={content}
